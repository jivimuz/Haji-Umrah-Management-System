<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="{{$top}}" id="kode_agen" onkeypress="return event.charCode != 32" placeholder="Kode Agen (Max 5 Digit)" maxlength=5>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" inputmode="numeric" pattern="[0-9]" onkeypress="return /[0-9]/i.test(event.key)" id="noktp" placeholder="No Ktp" maxlength="16">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
