<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" disabled class="form-control editable" id="nama_paket" placeholder="Nama Paket"
                value="{{ $data->nama }}" maxlength="50">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select id="program" disabled class="form-control editable select2modal " style="width: 100%">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="date" value="{{ date('Y-m-d', strtotime($data->flight_date)) }}" disabled
                class="form-control editable" id="flight_date" min="{{ date('Y-m-d') }}">
        </div>
    </div>
    @if ($total->total > 0)
        <div class="col-md-4">
