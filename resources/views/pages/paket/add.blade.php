<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_paket" placeholder="Nama Paket" maxlength="50">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select id="program" class="form-control select2modal " style="width: 100%">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="publish_price" placeholder="Publish price" inputmode="numeric"  onkeypress="return /[0-9]/i.test(event.key)" maxlength="50">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="basic_price" placeholder="Basic price" inputmode="numeric"  onkeypress="return /[0-9]/i.test(event.key)" maxlength="50">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="">Flight Date: <span class="text-danger">*</span></label>
            <input type="date" class="form-control" id="flight_date" min="{{date('Y-m-d')}}">
        </div>
    </div>
...
<script>
    ...
    function pushData(){
        ...
        var publish_price = $('#publish_price').val()
        var basic_price = $('#basic_price').val()
        var flight_date = $('#flight_date').val()
        console.log(nama,program,publish_price,basic_price,flight_date)

        if(!nama || !program || !publish_price  || !basic_price || !flight_date){
            return Toast.fire({
                    icon: "warning",
