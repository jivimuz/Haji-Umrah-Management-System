<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="publish_price" placeholder="Publish price"
                inputmode="numeric" onkeypress="return /[0-9]/i.test(event.key)" onchange="noMinus(this)"
                maxlength="50">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="basic_price" placeholder="Basic price" inputmode="numeric"
