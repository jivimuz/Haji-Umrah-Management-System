<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <select id="gender" class="form-control select2modal editable" style="width: 100%" disabled>
                <option value="">-</option>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control editable" id="born_place"
                        value="{{ $data->born_place }}" placeholder="Tempat Lahir" maxlength="50">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="">Tanggal Lahir: <span class="text-danger">*</span></label>
                    <input type="date" disabled class="form-control editable" id="born_date"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control editable" id="nama_ayah"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control editable" id="nama_ibu"
...
<script>
    ...
    function pushData() {
        ...
        if (!nama || !paket_id || !no_ktp || !no_hp || !gender || !agen_id || !born_place) {
            return Toast.fire({
                icon: "warning",
